...
const MessagesView: React.FC<MessagesViewProps> = ({ currentUser, conversations: initialConversations }) => {
  ...
  return (
    <div className="w-full h-screen md:h-[calc(100vh-4rem)] bg-black md:border border-gray-800 flex flex-col md:flex-row">
        <div className={`w-full md:w-96 border-r border-gray-800 flex-shrink-0 flex flex-col ${selectedConversation ? 'hidden md:flex' : 'flex'}`}>
            <div className="p-4 border-b border-gray-800 flex justify-between items-center flex-shrink-0">
                ...
                <button><Icon className="w-6 h-6"><path d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" /></Icon></button>
            </div>
