  ...
  return (
    <aside className="fixed top-0 left-0 h-screen bg-black border-r border-gray-800 p-3 z-40 hidden md:flex flex-col">
       ...
       <div className="relative">
           <button onClick={() => setMoreMenuOpen(p => !p)} className="w-full flex items-center gap-4 p-3 rounded-lg hover:bg-gray-800 transition-colors">
              <Icon className="w-7 h-7"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></Icon>
