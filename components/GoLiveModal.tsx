        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4" onClick={onClose}>
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md border border-gray-200" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-6 space-y-4">
                    <div>
                        <label className="text-sm text-gray-600 mb-1 block">Live Stream Title (Optional)</label>
                        <input
                            type="text"
                            value={title}
                     ...
                     <button
                        onClick={handleStart}
                        disabled={isLoading}
                        className="w-full bg-blue-600 text-white font-bold py-3 rounded-md mt-4 disabled:bg-blue-400"
                    >
