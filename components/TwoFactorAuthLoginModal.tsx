    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4" onClick={onClose}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {error && <p className="text-red-500 text-sm bg-red-100 p-2 rounded-md text-center">{error}</p>}
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-100 border border-gray-300 rounded-md p-3 text-center text-2xl tracking-[0.5em] focus:outline-none focus:ring-1 focus:ring-blue-500"
              required
              autoFocus
              disabled={isLoading}
            />
