      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="w-full text-left p-3 rounded-lg flex items-center justify-between gap-4">
            ...
            <ToggleSwitch enabled={currentUser.notificationSettings.likes} setEnabled={(val) => onUpdateNotificationSettings('likes', val)} />
          </div>
           <div className="w-full text-left p-3 rounded-lg flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
            ...
            <ToggleSwitch enabled={currentUser.notificationSettings.comments} setEnabled={(val) => onUpdateNotificationSettings('comments', val)} />
          </div>
           <div className="w-full text-left p-3 rounded-lg flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
            ...
            <ToggleSwitch enabled={currentUser.notificationSettings.follows} setEnabled={(val) => onUpdateNotificationSettings('follows', val)} />
          </div>
        </div>
