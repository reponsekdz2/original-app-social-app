  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      <div className="relative">
        ...
        <div className={`flex items-center gap-2 bg-gray-800 border border-gray-700 ${replyingTo ? 'rounded-b-full' : 'rounded-full'} px-2 py-1.5`}>
            {isRecording ? (
                <div className="flex items-center w-full px-2">
                    <button onClick={handleStopRecording} className="p-1.5 text-red-500"><Icon className="w-6 h-6" fill="currentColor"><path d="M5.25 7.5A2.25 2.25 0 017.5 5.25h9a2.25 2.25 0 012.25 2.25v9a2.25 2.25 0 01-2.25 2.25h-9a2.25 2.25 0 01-2.25-2.25v-9z" /></Icon></button>
                    <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse mx-3"></div>
                    <span className="font-mono text-sm text-gray-300">{formatRecordingTime(recordingTime)}</span>
                </div>
            ) : (
                <>
                    ...
                    {text ? (
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button onClick={handleStartRecording} className="p-1.5 rounded-full hover:bg-gray-700">
