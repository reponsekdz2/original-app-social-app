    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
                 <button onClick={() => onNavigate('support_inbox')} className="p-6 bg-gray-800/50 hover:bg-gray-800 rounded-lg text-left">
                    <h3 className="font-bold">Support Inbox</h3>
                    <p className="text-sm text-gray-400">View your past and current support requests.</p>
                </button>
                <button onClick={() => onNavigate('faq')} className="p-6 bg-gray-800/50 hover:bg-gray-800 rounded-lg text-left">
