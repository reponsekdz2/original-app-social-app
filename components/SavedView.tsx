      ...
      {posts.length > 0 ? (
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-2 lg:grid-cols-4 2xl:grid-cols-5">
            ...
            return (
              <div key={post.id} className="relative aspect-square group cursor-pointer" onClick={() => onViewPost(post)}>
                {firstMedia.type === 'video' ? (
                  ...
                  <img src={firstMedia.url} alt="Saved post" className="w-full h-full object-cover" />
                )}
                {post.media.length > 1 && (
         ...
         <div className="text-center text-gray-500 pt-16">
            <Icon className="w-16 h-16 mx-auto mb-4"><path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.5 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0z" /></Icon>
